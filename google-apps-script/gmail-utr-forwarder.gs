...
function checkHdfcEmails() {
  ...
  var query = 'from:(alerts@hdfcbank.com OR noreply@hdfcbank.com OR alerts@hdfcbank.net) "UPI Reference No" -label:' + PROCESSED_LABEL;
...
function reprocessPast() {
  ...
  var query = 'from:(alerts@hdfcbank.com OR noreply@hdfcbank.com OR alerts@hdfcbank.net) "UPI Reference No"';
