        ...
        <AnimatePresence mode="wait" initial={false}>
          ...
          {step === 4 && (
            ...
            >
              ...
              >
                <p className="text-sm break-all" style={{ color: "rgba(255,215,0,0.7)", fontFamily: "monospace", fontSize: 11 }}>
                  {shareUrl}
                </p>
              </div>
              ...
              <div className="flex gap-3 w-full mb-4">
                <motion.button
                  ...
                  style={{
                    ...
                    padding: "13px",
                    borderRadius: 12,
                    background: copied ? "linear-gradient(135deg, #22c55e, #16a34a)" : "rgba(255,215,0,0.12)",
                    color: copied ? "white" : "rgba(255,215,0,0.9)",
                    fontWeight: 600, fontSize: 14,
                    display: "flex", alignItems: "center", justifyContent: "center", gap: 7,
                    cursor: "pointer", border: "1px solid rgba(255,215,0,0.25)",
                    transition: "all 0.3s",
                  }}
                >
              ...
              <button
                onClick={() => { setStep(1); setOccasion(""); setRelation(""); setRecipientName(""); setLikes(""); setCustomMsg(""); setShareUrl(""); }}
