...
export default function Card() {
  ...
  /* When Clerk finishes loading and the user IS signed in, close the gate
     so they land back on the card page with share buttons unlocked. */
  useEffect(() => {
          ...
          >
            ...
            {isSender && (
              <motion.div
                ...
                style={{ width: "min(340px, calc(100vw - 32px))", paddingBottom: 8 }}
              >
