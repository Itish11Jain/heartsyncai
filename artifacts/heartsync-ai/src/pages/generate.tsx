            ...
            <div>
              ...
              <div className="bg-card/50 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-1">5 Guides for ₹49</h3>
                  ...
                  <div className="flex gap-5 items-center mb-8">
                    <div className="bg-white rounded-xl p-2 shadow-lg shrink-0">
                      <img
                        src="https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=upi://pay?pa=8905158970@upi%26pn=HeartSync%20AI%26am=49%26cu=INR%26tn=HeartSync+Reports"
                        alt="UPI QR Code"
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-white/35 mt-2">Amount: ₹49</p>
