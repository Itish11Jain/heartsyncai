      ...
      >
        ...
        <div className="bg-card/60 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 h-11 rounded-xl border border-white/12 bg-white/5 hover:bg-white/10 transition-all mb-4 text-sm font-semibold text-white disabled:opacity-50"
          >
            {isLoading ? (
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[11px] text-white/25 font-medium">or use email / phone</span>
            <div className="h-px flex-1 bg-white/10" />
          </div>
