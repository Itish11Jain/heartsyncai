      ...
      <AnimatePresence>
        {showSignIn && (
          <motion.div
            ...
            onClick={(e) => { if (e.target === e.currentTarget) { setShowSignIn(false); setGoogleAuthLoading(false); } }}
          >
            <motion.div
              initial={{ scale: 0.93, opacity: 0, y: 20 }}
              animate={{ scale: 1, opacity: 1, y: 0 }}
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  background: googleAuthLoading ? "rgba(255,255,255,0.08)" : "#fff",
                  border: "none", borderRadius: 14,
                  display: "flex", alignItems: "center", justifyContent: "center", gap: 12,
                  cursor: googleAuthLoading ? "default" : "pointer",
                  transition: "background 0.2s, opacity 0.2s",
                  opacity: googleAuthLoading ? 0.7 : 1,
                  boxShadow: googleAuthLoading ? "none" : "0 4px 20px rgba(255,255,255,0.12)",
                }}
              >
                {/* Google G SVG */}
                {googleAuthLoading ? (
              ...
              <button
                onClick={() => { setShowSignIn(false); setGoogleAuthLoading(false); }}
