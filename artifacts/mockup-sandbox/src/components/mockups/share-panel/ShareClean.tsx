  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 10, color: "rgba(255,215,0,0.3)", marginTop: 18, letterSpacing: "0.06em" }}>
      ...
      {/* Make another card */}
      <p style={{ fontSize: 11, color: "rgba(255,255,255,0.2)", marginTop: 20, cursor: "pointer" }}>
        Make another card
      </p>
    </div>
  );
